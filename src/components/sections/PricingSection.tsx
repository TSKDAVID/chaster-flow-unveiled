...
import { IconCheck, IconStar, IconCrown, IconBolt, IconArrowRight } from '@tabler/icons-react';
      ...
      <div className="max-w-7xl mx-auto">
        <AnimatedSection animation="fade-up">
          <div className="text-center mb-16">
            ...
            <div className="inline-flex items-center glass-card rounded-lg p-1 hover:shadow-xl transition-all duration-300">
              <button
                onClick={() => setIsAnnual(false)}
                className={`px-6 py-3 rounded-md text-sm font-medium transition-all duration-300 hover-stable ${
              ...
              <button
                ...
                className={`px-6 py-3 rounded-md text-sm font-medium transition-all duration-300 relative hover-stable ${
                  isAnnual ? 'bg-primary text-primary-foreground shadow-lg scale-105' : 'text-muted-foreground hover:text-foreground'
                }`}
              >
                {t.pricing.annually}
            ...
            return (
              ...
              >
                <div className={`relative group ${
                  ...
                  <div className={`glass-card p-8 h-full group-hover:scale-105 transition-all duration-300 hover:shadow-xl ${
                    ...
                    <div className="text-center mb-8">
                      <div className="w-16 h-16 mx-auto mb-4 bg-primary/10 rounded-full flex items-center justify-center group-hover:bg-primary/20 transition-colors duration-300 group-hover:scale-110">
                        <IconComponent className={`w-8 h-8 ${plan.color} icon-float`} stroke={1.5} />
                      </div>
