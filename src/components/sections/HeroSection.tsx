      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        <AnimatedSection animation="fade-up" delay={200}>
          <div className="flex items-center justify-center mb-6">
            <IconBolt className="w-8 h-8 text-primary mr-3 icon-float" stroke={1.5} />
        ...
        <AnimatedSection animation="fade-up" delay={800}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              className="btn-primary px-8 py-4 text-lg font-semibold rounded-lg group transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-primary/25"
            >
              {t.hero.tryNow}
              <IconArrowRight className="w-5 h-5 ml-2 transition-transform duration-300 group-hover:translate-x-1" stroke={1.5} />
            </Button>
            ...
            <Button
              ...
              className="btn-secondary px-8 py-4 text-lg font-semibold rounded-lg group transition-all duration-300 hover:scale-105"
            >
              <IconPlayerPlay className="w-5 h-5 mr-2 transition-transform duration-300 group-hover:scale-110" stroke={1.5} />
              {t.hero.watchDemo}
            </Button>
          </div>
        </AnimatedSection>
        ...
        <div className="mt-16 flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-12">
          <AnimatedSection animation="scale-in" delay={1000}>
            <div className="glass-card px-6 py-3 hover:scale-105 transition-all duration-300">
