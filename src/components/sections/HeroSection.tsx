...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="section-container gradient-bg relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 w-full">
        <AnimatedSection animation="fade-up" delay={200}>
          <div className="flex items-center justify-center mb-4 sm:mb-6">
            ...
            <span className="text-primary font-semibold text-sm sm:text-lg">AI-Powered Customer Support</span>
          </div>
        </AnimatedSection>
        ...
        <div className="mt-12 sm:mt-16 flex flex-col sm:flex-row justify-center items-center space-y-3 sm:space-y-0 sm:space-x-6 lg:space-x-12 px-4">
          <AnimatedSection animation="scale-in" delay={1000}>
            <div className="glass-card px-4 sm:px-6 py-2 sm:py-3 hover:scale-105 transition-all duration-300">
              <div className="text-xl sm:text-2xl font-bold text-primary">10s</div>
              <div className="text-xs sm:text-sm text-muted-foreground whitespace-nowrap">Response Time</div>
            </div>
          </AnimatedSection>
          <AnimatedSection animation="scale-in" delay={1200}>
            <div className="glass-card px-4 sm:px-6 py-2 sm:py-3 hover:scale-105 transition-all duration-300">
              <div className="text-xl sm:text-2xl font-bold text-primary">50+</div>
              <div className="text-xs sm:text-sm text-muted-foreground whitespace-nowrap">Languages</div>
            </div>
          </AnimatedSection>
          <AnimatedSection animation="scale-in" delay={1400}>
            <div className="glass-card px-4 sm:px-6 py-2 sm:py-3 hover:scale-105 transition-all duration-300">
              <div className="text-xl sm:text-2xl font-bold text-primary">99.9%</div>
              <div className="text-xs sm:text-sm text-muted-foreground whitespace-nowrap">Uptime</div>
            </div>
          </AnimatedSection>
        </div>
      </div>
